...
export function PomodoroTimer(props: Props): JSX.Element {
    ...
    }, [setTimeCounting, setWorking, setResting, props.longRestTime, props.shortRestTime]);
    ...
    useEffect(() => {
        ...
        configureRest, configureWork, setCycles, 
        cycles, numberOfPomodoros, props.cycles, completedCycles]);
